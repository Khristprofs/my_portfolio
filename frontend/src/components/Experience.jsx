...
import { Card, CardContent, CardHeader, CardTitle } from "../components/ui/CardOne";
    ...
    <section className="py-12 md:py-24 mt-16">
      <div className="container px-4 md:px-6 mx-auto">
        ...
        <div className="flex justify-center mt-8 ">
          <Tabs defaultValue="all" className="w-full max-w-md bg-gray-100 rounded-2xl">
          ...
          <div className="relative mx-auto">
            ...
            {filteredExperiences.map((experience, index) => (
              ...
              >
                ...
                {/* Desktop Icon */}
                <div
                  className={`hidden md:block absolute -translate-y-6 ${index % 2 === 0
                      ? "right-[calc(50%+12px)]"
                      : "left-[calc(50%+12px)]"
                    } text-primary`}
                >
                ...
                {/* Mobile Icon */}
                <div
                  className={`md:hidden absolute -translate-y-6 ${index % 2 === 0
                      ? "left-[calc(50%+12px)]"
                      : "right-[calc(50%+12px)]"
                    } text-primary`}
                >
